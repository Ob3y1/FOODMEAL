...
<body>
    ...
    <header>
        ...
        <div class="right_area">
            <div id="a1">
            <form action="searchde.php" method="post">
                <button type="submit" name="name" id="buttonsearch"><img src="img/icons8-magnifier-67.png" id="img1"></button>
                <input type="text" id="inp1" name="inp1" placeholder="NAME_PART">
            </form>
                <a href="insertde.html"><img src="img/icons8-plus-67.png" id="img2"></a>
            </div>
        </div>
    </header>
    <div class="sidebar">
    ...
    <div class="content">
        <div class="scroll-bg" style="  position: absolute; background: transparent; margin: 70px 0px 0px 200px;">
